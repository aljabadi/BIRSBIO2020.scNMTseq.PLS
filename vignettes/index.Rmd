...
### all cells
```{r, fig.asp=0.9, fig.width=4, fig.align='center'}
...
### matching cells
```{r, fig.asp=0.7}
## flip UMAP_1 for consistency of legend location with previous plot
umap_1 <- rna.sce.matching@int_colData$reducedDims$UMAP[,1]
flip_umap_1 <- 
  mean(umap_1) - umap_1
rna.sce.matching@int_colData$reducedDims$UMAP[,1] <- flip_umap_1
...
# gg_rna_all
## matching cells
plot_reducedDim(sce = rna.sce.matching, reducedDim = 'UMAP', dims = c(1,2), col_palette = NULL, col = 'lineage') + theme(
      legend.position=c(1,0.6),
      legend.justification=c(1,0),
      legend.text=element_text(size=7, face = 'bold'),
      legend.title = element_text(size=8, face = 'bold')
