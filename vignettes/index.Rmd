...
```{r, eval=params$save_output, echo=FALSE}
ggsave(plot = gg_stage_lineage, filename = 'figures/plotIndiv-MultiModalSparsePLS-stage-lineage.pdf', width = 12, height = 6)
ggsave(plot = gg_stage, filename = 'figures/plotIndiv-MultiModalSparsePLS-stage.pdf', width = 10, height = 9)
```
