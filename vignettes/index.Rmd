...
cat('loading the data using SingleCellMultiModal package ...\n')
gastru.mae <- scNMT(dataType = 'mouse_gastrulation', modes = c('rna', 'met_*', 'acc_*'), dry.run = FALSE)
```
