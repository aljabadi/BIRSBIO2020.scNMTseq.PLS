...
ggplot(nipals_comps_df, aes(PC1, PC2)) + geom_point(aes(col = stage)) +
  scale_color_manual(values = col_palette) + facet_wrap(.~Modality, scales = 'free') +
...
Without imputation, except genebody methylation, the components from all assays are equally predictive. After imputation, the accuracy of the prediction is improved particularly for genebody methylation components.
